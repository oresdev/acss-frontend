   ...
   <nav class="nav">
      ...
      >
         <router-link
            ...
            >{{ $t('header.link.signup') }}</router-link
         >
         <router-link to="/" tag="li" v-if="this.$route.name === 'signup'">{{
            $t('header.link.signin')
         }}</router-link>
      </ul>
   </nav>
</template>
